...
$(".clicker").click(function(){
  ...
  // var showorhide = myClass[last].substr(2, 1);
  // if (showorhide === "S") {
  //     $("." + myClass[last]).toggle();
  //     var final = myClass[last].length;
  //     myClass = ".myHide" + myClass[last].substr(final - 1);
  //     $(myClass).toggle();
  // } else if (showorhide === "H") {
  //     $("." + myClass[last]).toggle();
  //     var final = myClass[last].length;
  //     myClass = ".myShow" + myClass[last].substr(final - 1);
  //     $(myClass).toggle();
  // } else {
  //     toggleView(myClass[last]);
  // }
...
function restore_options() {
    chrome.storage.sync.get(['rooturl',
        ...
        //     $("#idrooturl").val(items.rootURL);
        // } else {
        //     $("#idrooturl").val("https://chs.service-now.com");
        // }
        // if (isEmpty($("#idprimaryq").val())) {
        //     $("#idprimaryq").prop('readonly', true);
        //     $("#idrooturl").prop('readonly', false);
        // } else {
        //     $("#idprimaryq").prop('readonly', false);
